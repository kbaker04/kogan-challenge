    ...
    <Container className="mt-2">
      ...
      <Card className="mt-4">
        ...
        <Card.Body>
          ...
          <ul>
            <li>
              Create React App Project, entry: npx create-react-app project-name
            </li>
      ...
      <Card className="mt-4">
        ...
        <Card.Body>
          <p>
            In the project src directory you only need to keep the index.js file
          </p>
          <p>Inside src I created the following folders</p>
          <ul>
            <li>apis to hold reusable instances of axios configurations</li>
            <li>
              components - this directory only has one file, App.js but also the
              following folders
              <ul>
                <li>
      ...
      <Card className="mt-4">
        ...
        <Card.Body>
          <p>
            To checkout and run the project please do the following in
            powershell or command prompt on Windows
          </p>
          <ul>
            <li>
              Clone the repo, entry: git clone
              https://github.com/kbaker04/kogan-challenge
            </li>
            <li>
              Change into the project directory, entry: cd .\kogan-challenge\{" "}
            </li>
            <li>Install node module dependencies, entry: npm install </li>
            <li>Start the application!!! enter: npm run start</li>
          </ul>
        </Card.Body>
      </Card>
    </Container>
